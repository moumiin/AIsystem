...
const KCISA_SIGNS = [
  {
    ...
    emoji: '👋',
    aihubWord: '안녕하세요',
    videoUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20191004/624421/MOV000244910_700X466.mp4',
    thumbnailUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20191004/624421/MOV000244910_215X161.jpg',
    sourceUrl: 'http://sldict.korean.go.kr/front/sign/signContentsView.do?top_category=CTE&origin_no=3331',
    source: 'kcisa',
    hands: 2,
    description: '오른 손바닥으로 주먹을 쥔 왼 팔을 쓸어내린 다음, 두 주먹을 쥐고 바닥이 아래로 향하게하여 가슴 앞에서 아래로 내린다.',
    hint: 'KCISA 수어 영상 시범을 보고 얼굴, 팔, 손 동작을 함께 따라해보세요',
  },
  {
    id: 'kcisa_thanks',
    category: 'greet',
    ...
    emoji: '🙏',
    aihubWord: '감사합니다',
    videoUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20191028/632085/MOV000243986_700X466.mp4',
    thumbnailUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20191028/632085/MOV000243986_215X161.jpg',
    sourceUrl: 'http://sldict.korean.go.kr/front/sign/signContentsView.do?top_category=CTE&origin_no=2372',
    source: 'kcisa',
    hands: 2,
    description: '손끝이 밖으로 향하게 펴서 모로 세운 오른손의 4지 옆면을 손바닥이 아래로 향하게 편 왼 손등에 두 번 댄다.',
    hint: 'KCISA 수어 영상 시범을 보고 양손 위치와 접촉 동작을 따라해보세요',
  },
  {
    id: 'kcisa_gomapseumnida',
    category: 'greet',
    name: '고맙습니다',
    hidden: true,
    emoji: '🙏',
    ...
    source: 'kcisa',
    hands: 2,
    description: "KCISA에는 '고맙습니다' 정확 제목이 없어 '감사합니다,감사,고맙다' 항목을 연결했습니다.",
    hint: '감사합니다 영상과 같은 KCISA 수어 시범을 따라해보세요',
  },
  {
    id: 'kcisa_me',
    category: 'greet',
    ...
    emoji: '🙂',
    aihubWord: '나',
    videoUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20191028/631984/MOV000248548_700X466.mp4',
    thumbnailUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20191028/631984/MOV000248548_215X161.jpg',
    sourceUrl: 'http://sldict.korean.go.kr/front/sign/signContentsView.do?top_category=CTE&origin_no=11536',
    source: 'kcisa',
    hands: 1,
    description: '오른 손바닥을 가슴 중앙에 댄다.',
    hint: 'KCISA 수어 영상 시범을 보고 손바닥 위치를 따라해보세요',
  },
  {
    id: 'kcisa_polite_suffix',
    category: 'greet',
    name: '-ㅂ니다',
    hidden: true,
    emoji: '✋',
    aihubWord: '-ㅂ니다',
    videoUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20160325/285817/MOV000285886_700X466.mp4',
    thumbnailUrl: 'http://sldict.korean.go.kr/multimedia/multimedia_files/convert/20160325/285817/MOV000285886_215X161.jpg',
    sourceUrl: 'http://sldict.korean.go.kr/front/sign/signContentsView.do?top_category=CTE&origin_no=19943',
    source: 'kcisa',
    hands: 2,
    description: '손바닥이 위로 향하게 편 왼 손바닥에 오른 손바닥을 댔다가 오른쪽으로 내린다.',
    hint: 'KCISA 수어 영상 시범을 보고 양손 접촉 후 이동 방향을 따라해보세요',
  },
];
...
function makeBaeNumberPose(curls) {
  const result = BAE_OPEN_PALM.map(([x, y, z]) => [x, y, z]);
  for (const [finger, curl] of Object.entries(curls)) {
    for (const idx of FINGER_INDICES[finger]) {
      const a = BAE_OPEN_PALM[idx];
      const b = BAE_CLOSED_FIST[idx];
      result[idx] = [
        a[0] + (b[0] - a[0]) * curl,
        a[1] + (b[1] - a[1]) * curl,
        a[2] + (b[2] - a[2]) * curl,
...
const NUMBER_STATIC_POSES = {
  '1': makeBaeNumberPose({ thumb: 0.5, index: 0.0, middle: 1.0, ring: 1.0, pinky: 1.0 }),
  '2': makeBaeNumberPose({ thumb: 0.5, index: 0.0, middle: 0.0, ring: 1.0, pinky: 1.0 }),
  '3': makeBaeNumberPose({ thumb: 0.5, index: 0.0, middle: 0.0, ring: 0.0, pinky: 1.0 }),
  '4': makeBaeNumberPose({ thumb: 1.0, index: 0.0, middle: 0.0, ring: 0.0, pinky: 0.0 }),
  '5': makeBaeNumberPose({ thumb: 0.0, index: 0.0, middle: 0.0, ring: 0.0, pinky: 0.0 }),
...
const NUMBER_STATIC_TEXT = {
  '1': ['검지만 곧게 펴고 나머지 손가락은 접으세요', '검지 하나만 위로 세워요'],
  '2': ['검지와 중지를 펴고 V자 모양을 만드세요', '검지, 중지 두 손가락을 위로 펴요'],
  '3': ['검지, 중지, 약지 세 손가락을 펴세요', '세 손가락을 나란히 펴요'],
  '4': ['엄지를 제외한 네 손가락을 모두 펴세요', '엄지만 접고 나머지 네 손가락을 펴요'],
  '5': ['다섯 손가락을 모두 활짝 펴세요', '손바닥을 완전히 펴서 보여주세요'],
};

NUMBER_SIGNS.forEach(sign => {
  const pose = NUMBER_STATIC_POSES[sign.name];
  if (!pose) return;
  const text = NUMBER_STATIC_TEXT[sign.name];
  ...
  sign.hands = 1;
  sign.description = text?.[0] || `${sign.name} 지숫자 손모양입니다`;
  sign.hint = text?.[1] || `${sign.name} 지숫자 손모양을 카메라 앞에서 잠시 유지하세요`;
});
...
SIGNS.splice(0, SIGNS.length, ...NUMBER_SIGNS, ...KCISA_SIGNS, ...STUDY_SIGNS);
